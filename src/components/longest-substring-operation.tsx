...
import {
  ...
  getLongestSubString,
  saveResult,
} from "@/app/(protected)/longest-substring/actions";
...
export function LongestSubstringOperation() {
                ...
                <ScrollArea className="h-[calc(100dvh-120px)]">
                  <div className="flex flex-col gap-2">
                    {historyData?.map((value, index) => (
                      <Card key={index}>
                        <CardHeader>
                          <div className="flex flex-row items-center justify-between gap-2 sm:flex-wrap">
                            ...
                            <Button asChild variant="link" size="sm">
                              <Link
                                prefetch
                                href={`/longest-substring/${value.id}`}
                              >
                                View Calculation
                              </Link>
                            </Button>
